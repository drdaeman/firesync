...
def hkdf_expand(pseudo_random_key, info="", length=32, digest=hashlib.sha512):
    """
...
class Hkdf(object):
    ...
    def __init__(self, salt, input_key_material, digest=hashlib.sha256):
        """
        ...
        optionally takes a `digest` argument defining the hash function use,
